...
public class GamePanel extends JPanel{
	...
	public void paintComponent(Graphics page)
	{
		...
		if (areRectsColliding(myEnemy.getX(), myEnemy.getX() + 100, myEnemy.getY(), myEnemy.getY() + 100, myPlayer.getX(), myPlayer.getX() + 100, myPlayer.getY(), myPlayer.getY() + 100) == true)
		{
			...
			if (scoreCount > myGame.getBoardWinner1Score())
			{
				myGame.setBoardWinner1(myGame.getCharacterName());
				myGame.setBoardWinner1Score(myGame.getScore());
			}
			else if (scoreCount > myGame.getBoardWinner2Score())
			{
				myGame.setBoardWinner2(myGame.getCharacterName());
				myGame.setBoardWinner2Score(myGame.getScore());
			}
			else if (scoreCount > myGame.getBoardWinner3Score())
			{
				myGame.setBoardWinner3(myGame.getCharacterName());
				myGame.setBoardWinner3Score(myGame.getScore());
			}
